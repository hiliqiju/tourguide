...
def register_commands(app):
    ...
    def init_data():
        ...
        # 初始化Ticket表
        t1 = Ticket('日光岩', '成人票', 50.0, 1)
        t2 = Ticket('菽庄花园', '成人票', 30.0, 1)
        t3 = Ticket('皓月园', '成人票', 10.0, 1)
        t4 = Ticket('风琴博物馆', '成人票', 15.0, 1)
        t5 = Ticket('厦门海底世界', '成人票', 107.0, 1)
        t6 = Ticket('厦门海底世界', '儿童票', 58.0, 1)
        t7 = Ticket('灵隐飞来峰', '成人票', 45.0, 2)
        t8 = Ticket('灵隐飞来峰', '儿童票', 22.5, 2)
        t9 = Ticket('岳王庙', '成人票', 25.0, 2)
        t10 = Ticket('岳王庙', '儿童票', 12.5, 2)
        t11 = Ticket('北高峰索道', '成人票', 30.0, 2)
